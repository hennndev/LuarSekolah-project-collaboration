        ...
        <section className='px-[100px] py-[22px] mb-[100px]'>
            <section className='flex space-x-[70px]'>
                <section className='max-w-[811px] space-y-[30px]'>
                    <h1 className='text-[44px] text-primary font-bold tracking-[0.06em] leading-[72px]'>
                        Selayang Pandang
                    </h1>
            ...
            <section className='space-y-[50px] mt-[100px]'>
                <h2 className='text-[42px] text-primary font-semibold tracking-[0.06em] leading-[63px]'>
