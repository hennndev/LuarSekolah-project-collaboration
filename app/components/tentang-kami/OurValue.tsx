            ...
            <section className='flex-center space-x-[60px]'>
                <section className='w-[538px] flexx flex-col space-y-[60px]'>
                    ...
                    <section className='space-y-[10px]'>
                        <h3 className='text-[28px] leading-[42px] tracking-[0.015em] font-medium text-center'>Berani Untuk Memulai</h3>
                ...
                <section className='w-[538px] flexx flex-col space-y-[60px]'>
                    ...
                    <section className='space-y-[10px]'>
                        <h3 className='text-[28px] leading-[42px] tracking-[0.015em] font-medium text-center'>Relevan Dengan Zaman</h3>
                        <p className='text-[24px] leading-[38px] tracking-[0.12em] text-justify'>
                ...
                <section className='w-[538px] flexx flex-col space-y-[60px]'>
                    ...
                    <section className='space-y-[10px]'>
                        <h3 className='text-[28px] leading-[42px] tracking-[0.015em] font-medium text-center'>Terbaru Dan Terkurasi</h3>
                        <p className='text-[24px] leading-[38px] tracking-[0.12em] text-justify'> 
