...
const OurValue = () => {
    return (
        <section className='px-[100px] py-[22px] mb-[100px] space-y-[50px]'>
            <h2 className='text-primary text-[40px] leading-[63px] tracking-[0.06em] font-bold text-center'>Value LuarSekolah</h2>
            <section className='flex-center space-x-[60px]'>
                <section className='w-[538px] flexx flex-col space-y-[60px]'>
                    ...
                    <section className='space-y-[10px]'>
                        <h3 className='text-[26px] leading-[42px] tracking-[0.015em] font-medium text-center'>Berani Untuk Memulai</h3>
                        <p className='text-[22px] leading-[38px] tracking-[0.06em] text-justify'>
                ...
                <section className='w-[538px] flexx flex-col space-y-[60px]'>
                    ...
                    <section className='space-y-[10px]'>
                        <h3 className='text-[26px] leading-[42px] tracking-[0.015em] font-medium text-center'>Relevan Dengan Zaman</h3>
                        <p className='text-[22px] leading-[38px] tracking-[0.06em] text-justify'>
                ...
                <section className='w-[538px] flexx flex-col space-y-[60px]'>
                    ...
                    <section className='space-y-[10px]'>
                        <h3 className='text-[26px] leading-[42px] tracking-[0.015em] font-medium text-center'>Terbaru Dan Terkurasi</h3>
                        <p className='text-[22px] leading-[38px] tracking-[0.06em] text-justify'> 
