    ...
    return (
        <footer className='px-[100px] py-[22px] space-y-[100px] pb-[50px]'>
            <section className='space-y-[30px]'>
                ...
                <section className='flex-between space-x-[100px]'>
                    <section className='w-[657px] space-y-[30px]'>
                        <p className='text-[20px] leading-[38px] tracking-[0.04em] text-left w-full'>
                        ...
                        <section className='space-y-[35px]'>
                            <section className='space-y-[15px]'>
                                <p className='text-[20px] font-semibold leading-[30px] tracking-[0.04em]'>Ikuti Kami</p>
                            ...
                            <section className='space-y-[15px]'>
                                <p className='text-[20px] leading-[30px] tracking-[0.04em] font-semibold'>Hubungi Kami</p>
                                <section className='space-y-[10px]'>
                                    <Link href={whatsappUrl} target="_blank" className='flexx space-x-[20px]'>
                                        ...
                                        <p className='text-[20px] leading-[30px] font-medium tracking-[0.04em]'>0811 2021 444</p>
                                    </Link>
                                    ...
                                    <Link href={mailUrl} target="_blank" className='flexx space-x-[20px]'>
                                        ...
                                        <p className='text-[20px] leading-[30px] font-medium tracking-[0.04em]'>info@luarsekolah.com</p>
                                    </Link>
                                </section>
                            </section>

                            <section className='space-y-[15px]'>
                                <p className='text-[20px] font-semibold leading-[30px] tracking-[0.04em]'>Unduh Aplikasi</p>
                    ...
                    <section className='w-[861px] space-y-[50px]'>
                        <section className='flex space-x-[10px]'>
                            ...
                            <section className='flex flex-1 space-x-[10px]'>
                                ...
                                <p className='flex-1 text-[18px] leading-[38px] tracking-[0.04em] text-[#888888]'>
                        ...
                        <section className='w-full flex justify-between'>
                            <section className='space-y-[10px]'>
                                <p className='text-[20px] leading-[30px] tracking-[0.04em] font-semibold'>Informasi</p>
                                <section className='flex flex-col space-y-[5px]'>
                                    <Link href="/tentang-kami" className='text-[20px] leading-[30px] tracking-[0.04em] cursor-pointer hover:text-primary'>Tentang Kami</Link>
                                    <Link href="/aktivitas-kami" className='text-[20px] leading-[30px] tracking-[0.04em] cursor-pointer hover:text-primary'>Aktivitas Kami</Link>
                                    <Link href="https://luarsekolah.com/article" target='_blank' className='text-[20px] leading-[30px] tracking-[0.04em] hover:text-primary'>Blog</Link>
                                    <Link href="https://luarsekolah.com/promo" target='_blank' className='text-[20px] leading-[30px] tracking-[0.04em] hover:text-primary'>Promo</Link>
                                    <Link href="https://luarsekolah.com/bantuan" target="_blank" className='text-[20px] leading-[30px] tracking-[0.04em] hover:text-primary'>FAQ</Link>
                                    <Link href="https://luarsekolah.com/komunitas" target="_blank" className='text-[20px] leading-[30px] tracking-[0.04em] hover:text-primary'>Komunitas</Link>
                                </section>
                            </section>
                            <section className='space-y-[10px]'>
                                <p className='text-[20px] leading-[30px] tracking-[0.04em] font-semibold'>Program</p>
                                <section className='flex flex-col space-y-[5px]'>
                                    <Link href="https://luarsekolah.com/prakerja" target="_blank" className='text-[20px] leading-[30px] tracking-[0.04em] cursor-pointer hover:text-primary'>Prakerja</Link>
                                    <Link href="https://belajarbekerja.com" target="_blank" className='text-[20px] leading-[30px] tracking-[0.04em] cursor-pointer hover:text-primary'>Belajar Bekerja</Link>
                                    <Link href="https://luarsekolah.com/indonesia-skills-week" target="_blank" className='text-[20px] leading-[30px] tracking-[0.04em] cursor-pointer hover:text-primary'>Indonesia Skills Week</Link>
                                </section>
                            </section>
                            <section className='space-y-[10px]'>
                                <p className='text-[20px] leading-[30px] tracking-[0.04em] font-semibold'>Lainnya</p>
                                <section className='flex flex-col space-y-[5px]'>
                                    <Link href="#" className='text-[20px] leading-[30px] tracking-[0.04em] hover:text-primary'>Ajukan Penawaran</Link>
                                    <Link href="https://luarsekolah.com/pages#terms-of-use" target="_blank" className='text-[20px] leading-[30px] tracking-[0.04em] hover:text-primary'>Syarat & Ketentuan</Link>
                                    <Link href="https://luarsekolah.com/pages#privacy-policy" target='_blank' className='text-[20px] leading-[30px] tracking-[0.04em] hover:text-primary'>Kebijakan Privasi</Link>
                                </section>
                            </section>
                        </section>  
                    </section>
            ...
            <section className='flex-between'>
                <p className='text-[20px] leading-[38px] tracking-[0.04em]'>PT Teknologi Edukasi Indonesia</p>
                <p className='text-[20px] leading-[38px] tracking-[0.04em]'>Copyright &#169; 2022 &#xb7; All Right Reserved</p>
            </section>
        </footer>
    )
}
